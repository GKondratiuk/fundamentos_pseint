//Escriba un subprograma nombrado cambio() que tenga un parámetro 
//en número entero y seis parámetros de referencia en número entero 
//nombrados cien, cincuenta, veinte, diez, cinco y uno, respectivamente. 
//La función tiene que considerar el
//valor entero transmitido como una cantidad en dólares y convertir 
